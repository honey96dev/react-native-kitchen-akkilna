    ...
    return (
      <Container style={{ backgroundColor: "white" }}>
        ...
        <View style={{ marginLeft:20}}>
            <Text style={{fontFamily:'Poppins_bold', mariginLeft: 10, marginTop:10, fontSize: 28 }}>Active Orders</Text>
            </View>
        <View
          style={{
            height: height - 150,
        ...
        >
         ...
         <Form style={{ flexDirection:'row'}}>
           <Label style={{paddingTop:10, fontSize:20, fontWeight:'bold'}}>Update Status:  </Label>
            <Picker
              mode="dropdown"
              iosHeader="Update Status"
              style={{ width: undefined, backgroundColor:"#EDEDED", borderWidth:2, borderColor:'greenhttp://localhost:8888/new/akkilna/adminaddkitchen' }}
              selectedValue={this.state.selected}
              onValueChange={this.onValueChange.bind(this)}
            >
              <Picker.Item label="Accepted" value="key0" />
              <Picker.Item label="Preparing" value="key1" />
              <Picker.Item label="Ready for Pickup" value="key2" />
            </Picker>
          </Form>
          </Content>
