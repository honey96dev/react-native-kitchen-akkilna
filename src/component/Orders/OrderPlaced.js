                ...
                >
                        ...
                        <View style={{marginTop: 22, padding: 10}}>
                            <View style={{marginTop: 20, marginLeft: 10}}>
                                ...
                                <View>
                                    ...
                                    />
                                    <Button onPress={this.acceptButton.bind(this)} style={{
                                        marginTop: 10,
                                        width: '100%',
                                        alignContent: 'center',
                                        justifyContent: 'center'
                                    }} success><Text>Confirm Pickup Time</Text></Button>
                                </View>
                            </View>
                        </View>
                    </Modal>
                    ...
                    <Content>
                        ...
                        <Content style={{marginBottom: 40}}>
                            <Button onPress={() => this.props.navigation.navigate("OrderPlaced")} style={{
                                marginTop: 10,
                                width: '100%',
                                alignContent: 'center',
                                justifyContent: 'center'
                            ...
                            }} success><Text>Accept</Text></Button>
                            <Button onPress={() => this.props.navigation.navigate("Rejected")} style={{
                                marginTop: 10,
                                width: '100%',
                                alignContent: 'center',
                                justifyContent: 'center'
                            }} danger><Text>Reject</Text></Button>
