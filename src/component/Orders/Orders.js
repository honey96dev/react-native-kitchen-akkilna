    ...
    return (
      <Container style={{ backgroundColor: "white" }}>
        ...
        <View style={{ marginTop: 20, height: height - 150 }}>
          <Content>
          <List>
          <ListItem style={{height: 70}} onPress={() => this.props.navigation.navigate("Accepted")}>
              <Left>
                <Text>Accepted</Text>
              </Left>
              <Right>
            ...
            <ListItem style={{height: 70}} onPress={() => this.props.navigation.navigate("Rejected")}>
              <Left>
                <Text>Rejected</Text>
              </Left>
              <Right>
            ...
            <ListItem style={{height: 70}} onPress={() => this.props.navigation.navigate("Disputed")}>
              <Left>
                <Text>Disputed</Text>
              </Left>
              <Right>
