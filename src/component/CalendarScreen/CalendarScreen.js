...
class CalendarScreen extends Component {
  ...
  render() {
    return (
      ...
      <Text style={{fontFamily:'Poppins_bold', mariginLeft: 10, marginTop:10, fontSize: 28 }}>Planner</Text>
      </View>
      <Agenda
        ...
        rowHasChanged={this.rowHasChanged.bind(this)}
         ...
         markedDates={{
            ...
            '2019-01-02': {startingDay: true, color: 'gray'},
            '2019-01-03': {color: 'gray'},
            '2019-01-03': {endingDay: true, color: 'gray'}}}
          monthFormat={'yyyy'}
